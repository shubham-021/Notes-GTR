...
These four concepts work together in a continuous cycle: user input creates a message, which triggers Update, which produces new state, which View renders to the screen, and the cycle repeats.
